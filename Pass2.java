...
public class Pass2 {
	public static void main(String[] Args) throws IOException{
	     ...
	     HashMap<Integer, String> symSymbol = new HashMap<Integer, String>(); //key-Value
	     ...
	     while((s=b2.readLine())!=null){	//symbtab
	    	 String word[]=s.split("\t\t\t");
	    	 symSymbol.put(symtabPointer++,word[1]);
	     }
	     while((s=b3.readLine())!=null){	//littab
	    	 String word[]=s.split("\t\t");
	    	 litSymbol.put(littabPointer,word[0]);
	    	 litAddr.put(littabPointer++,word[1]);
	     }
	     while((s=b1.readLine())!=null){		//intermediate 
